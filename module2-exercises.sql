...
-- Exercise 2: Retrieve titles with a price greater than 50 from the titles table


-- Exercise 3: Retrieve publishers located in 'New York' from the publishers table


-- Exercise 4: Retrieve stores with a zip code of '10001' from the stores table
...
-- Exercise 1: Retrieve authors with an au_id equal to '1002' from the authors table
...
-- Exercise 5: Retrieve titles with a price greater than or equal to 50 from the titles table
...
-- Exercise 1: Retrieve authors with a contract status of '1' and a city of 'New York' from the authors table
...
-- Exercise 2: Retrieve titles with a title containing 'SQL' from the titles table
...
-- Exercise 1: Retrieve authors with a phone number that is null from the authors table


-- Exercise 2: Retrieve titles with a notes column that is not null from the titles table


-- Exercise 3: Retrieve authors with a city that is null or an empty string from the authors table


-- Exercise 4: Retrieve titles with a price that is not null from the titles table


-- Exercise 5: Retrieve authors with a contract status that is null from the authors table
...
-- Exercise 2: Retrieve titles with a price less than 20 and published by 'Algodata Infosystems' (pub_id: 1389) from the titles table


-- Exercise 3: Retrieve titles with a price less than 10 or greater than 100 and not published by 'Algodata Infosystems' (pub_id: 1389) from the titles table


-- Exercise 4: Retrieve authors with a contract status of '0' or a city of 'Chicago' and a state of 'IL' from the authors table


-- Exercise 5: Retrieve authors with a contract status of '1' and a city of 'New York' or 'Chicago' from the authors table
